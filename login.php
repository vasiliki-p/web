...
<html>
    ...
    <body>
        <div class="login">
            ...
            <!-- Το σταθερό "αόρατο" κουτάκι με κλειδωμένο ύψος 20px -->
            <div style="height: 20px; line-height: 20px; color: #ff4c4c; text-align: center; font-size: 13px; font-weight: bold; margin-bottom: 10px;">
                <?php echo $error_msg; ?>
            </div>
        ...
        <!-- Επιστροφή στο δικό σου σταθερό footer -->
